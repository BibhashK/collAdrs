...
public sealed class Windows_Form1 : OpenSpan.Design.DesignForm
{
	...
	[OpenSpan.Design.ComponentIdentityAttribute("DesignForm-8D5F933376DDB37\\TextBox-8D5FB8EBCE81FFF")]
	...
	public Windows_Form1()
	{
		...
		// Set component Ids
		// 
		this.SetId(this.textBox1, new OpenSpan.Design.ComponentIdentity("TextBox-8D5FB8EBCE81FFF"));
	...
	internal System.Windows.Forms.TextBox Create_textBox1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(textBox1, new OpenSpan.Design.ComponentIdentity("TextBox-8D5FB8EBCE81FFF"));
		textBox1.Location = new System.Drawing.Point(138, 94);
