    ...
    <OpenSpan.Adapters.Web.WebAdapter Name="Web Application1" Id="WebAdapter-8D5F93350FFB532">
      ...
      <Content Name="Controls">
        <Items>
          ...
          <OpenSpan.Adapters.Web.Controls.WebPage Name="iim_ranchi_address_Subtraction_Bing" Id="WebPage-8D5FB91EE51A402">
            <DummyPropertyToDetectReplaceUndo Value="0" />
            <ForwardObjectExplorerEvent Value="True" />
            <IsGlobal Value="True" />
            <MatchingIndex Value="0" />
            ...
            <Content Name="Controls">
              <Items>
                <OpenSpan.Adapters.Web.Controls.WebControl Name="Suchana_Bhawan_Audrey_House_Campus_" Id="WebControl-8D5FB91EE48A317">
                  <DummyPropertyToDetectReplaceUndo Value="0" />
                  <ForwardObjectExplorerEvent Value="True" />
                  <MatchingIndex Value="19" />
                  <TagName Value="SPAN" />
                  ...
                  <Content Name="MatchRules">
                    <Items>
                      <OpenSpan.Adapters.Web.MatchRules.ElementPathMatchRule Name="elementPathMatchRule7" Id="ElementPathMatchRule-8D5FB91EE6616E8">
                        <ElementPath Value="Binary">
                          <Binary>AAEAAAD/////AQAAAAAAAAARAQAAAAoAAAAGAgAAAARTUEFOBgMAAAADRElWBgQAAAADRElWBgUAAAADRElWBgYAAAADRElWBgcAAAACTEkGCAAAAAJPTAYJAAAAA0RJVgYKAAAABEJPRFkGCwAAAARIVE1MCw==</Binary>
                        </ElementPath>
                      </OpenSpan.Adapters.Web.MatchRules.ElementPathMatchRule>
            ...
            <Content Name="MatchRules">
              <Items>
                <OpenSpan.Adapters.Web.MatchRules.DocumentUrlMatchRule Name="documentUrlMatchRule8" Id="DocumentUrlMatchRule-8D5FB91EE580CCC">
                  <Fragment Value="Simple|True|(User Culture)|" />
                  <Host Value="Simple|True|(User Culture)|www.bing.com" />
                  <Path Value="Simple|True|(User Culture)|/search" />
                  <Port Value="80" />
                ...
                <OpenSpan.Adapters.Web.MatchRules.DocumentTitleMatchRule Name="documentTitleMatchRule8" Id="DocumentTitleMatchRule-8D5FB91EE5AF30F">
                  <Text Value="Simple|True|(User Culture)|iim ranchi address - Bing" />
                </OpenSpan.Adapters.Web.MatchRules.DocumentTitleMatchRule>
              </Items>
            </Content>
          </OpenSpan.Adapters.Web.Controls.WebPage>
